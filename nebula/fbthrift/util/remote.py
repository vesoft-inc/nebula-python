...
Used by PyRemote files generated by
  /fbthrift/compiler/generate/t_py_generator.cc
...
def print_functions(functions, service_names, out, local_only=False):
    """Print all the functions available from this fbthrift service"""
...
def __json_output_handler(ret):
    ...
    There is no need to handle the type ambiguity between Json dict and
        fbthrift structs, because pyremote knows what type the services want,
...
@add_format("python", "input", (
    ...
    'the fbthrift function accepts that argument as a string. In that '
...
@add_format("python_eval_stdin", "input", (
    ...
    'which represents the input argument list to the fbthrift function.'
))
...
@add_format("json", "input", (
    ...
    'the fbthrift function\'s parameters to the value you want to pass '
    'in. Make sure to represent fbthrift objects using the same format '
...
class RemoteClient(object):
    ...
    def _get_client(self, options):
        """Get the fbthrift client that will be used to make method calls"""
    ...
    CMDLINE_OPTIONS = list(RemoteTransportClient.CMDLINE_OPTIONS) + [(
        ...
        ('-F', '--fuzz'),
        {
            ...
            'help': ('Use TFuzzyHeaderTransport to send a fuzzed message for '
                     'testing fbthrift transport. Optionally include a list of '
        ...
        cls.register_cmdline_options((
            ...
            (
                ('-g', '--generate-template'),
                {
                    ...
                    'help': (
                        'Generate a template for a fbthrift struct, OR, arguments of '
