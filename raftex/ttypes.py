...
__all__ = ['UTF8STRINGS', 'ErrorCode', 'AskForVoteRequest', 'AskForVoteResponse', 'LogEntry', 'AppendLogRequest', 'AppendLogResponse', 'SendSnapshotRequest', 'SendSnapshotResponse', 'ClusterID', 'GraphSpaceID', 'PartitionID', 'TermID', 'LogID', 'IPv4', 'Port']
...
class AskForVoteRequest:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.I32:
          self.candidate_ip = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.I32:
  ...
  def write(self, oprot):
    ...
    if self.part != None:
      ...
      oprot.writeFieldEnd()
    if self.candidate_ip != None:
      oprot.writeFieldBegin('candidate_ip', TType.I32, 3)
      oprot.writeI32(self.candidate_ip)
      oprot.writeFieldEnd()
  ...
  def __repr__(self):
    ...
    if self.candidate_ip is not None:
      value = pprint.pformat(self.candidate_ip, indent=0)
      value = padding.join(value.splitlines(True))
      L.append('    candidate_ip=%s' % (value))
...
class AppendLogRequest:
  ...
  def write(self, oprot):
    ...
    if self.committed_log_id != None:
      ...
      oprot.writeFieldEnd()
    if self.leader_ip != None:
      oprot.writeFieldBegin('leader_ip', TType.I32, 6)
      oprot.writeI32(self.leader_ip)
      oprot.writeFieldEnd()
  ...
  def __repr__(self):
    ...
    if self.leader_ip is not None:
      value = pprint.pformat(self.leader_ip, indent=0)
      value = padding.join(value.splitlines(True))
      L.append('    leader_ip=%s' % (value))
...
class AppendLogResponse:
  ...
  def write(self, oprot):
    ...
    if self.current_term != None:
      ...
      oprot.writeFieldEnd()
    if self.leader_ip != None:
      oprot.writeFieldBegin('leader_ip', TType.I32, 3)
      oprot.writeI32(self.leader_ip)
      oprot.writeFieldEnd()
    if self.leader_port != None:
...
AskForVoteRequest.thrift_spec = (
  ...
  (3, TType.I32, 'candidate_ip', None, None, 2, ), # 3
...
def AskForVoteRequest__init__(self, space=None, part=None, candidate_ip=None, candidate_port=None, term=None, last_log_id=None, last_log_term=None,):
  self.space = space
  self.part = part
  self.candidate_ip = candidate_ip
...
def AskForVoteRequest__setstate__(self, state):
  ...
  state.setdefault('candidate_ip', None)
...
AppendLogRequest.thrift_spec = (
  ...
  (6, TType.I32, 'leader_ip', None, None, 2, ), # 6
...
def AppendLogRequest__init__(self, space=None, part=None, current_term=None, last_log_id=None, committed_log_id=None, leader_ip=None, leader_port=None, last_log_term_sent=None, last_log_id_sent=None, log_term=None, log_str_list=None, sending_snapshot=None,):
  self.space = space
  self.part = part
...
def AppendLogRequest__setstate__(self, state):
  ...
  state.setdefault('leader_ip', None)
...
AppendLogResponse.thrift_spec = (
  ...
  (3, TType.I32, 'leader_ip', None, None, 2, ), # 3
...
def AppendLogResponse__init__(self, error_code=None, current_term=None, leader_ip=None, leader_port=None, committed_log_id=None, last_log_id=None, last_log_term=None,):
  self.error_code = error_code
  self.current_term = current_term
  self.leader_ip = leader_ip
  self.leader_port = leader_port
...
def SendSnapshotRequest__init__(self, space=None, part=None, term=None, committed_log_id=None, committed_log_term=None, leader_ip=None, leader_port=None, rows=None, total_size=None, total_count=None, done=None,):
  self.space = space
  self.part = part
  self.term = term
  self.committed_log_id = committed_log_id
