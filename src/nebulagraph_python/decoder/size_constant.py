...
GEO_SHAPE_SIZE = 1
GEO_SRID_SIZE = 4
GEO_POINT_COORDINATE_SIZE = 8
GEO_COORDINATE_NUMBER_SIZE = 4
GEO_LINEAR_RING_NUMBER_SIZE = 4
GEO_LINEAR_RING_INDEX_SIZE = 4

# SET and MAP sizes
SET_HEADER_SIZE = 8
MAP_HEADER_SIZE = 8
ELEMENT_NUMBER_SIZE_FOR_SET = 4
ELEMENT_NUMBER_SIZE_FOR_MAP = 4
