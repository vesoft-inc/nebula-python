...
Based on whether --host or --url is specified as a command-line option,
...
SELECTOR_OPTIONS attribute, and you can specify additional command-line options
...
from nebula2.fbthrift.transport.THeaderTransport import THeaderTransport
from nebula2.fbthrift.protocol import TBinaryProtocol, TCompactProtocol, \
...
def __eval_arg(arg, thrift_types):
    """Evaluate a command-line argument within the scope of the IF types"""
    code_globals = {}
...
class RemoteClient(object):
    ...
    def _process_args(self, cmdline_args):
        """Populate instance data using command-line arguments"""
