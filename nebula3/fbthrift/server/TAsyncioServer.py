...
from nebula3.fbthrift.server.TServer import TServerEventHandler
from nebula3.fbthrift.Thrift import (
    TException,
    TProcessor,
)
from nebula3.fbthrift.util.async_common import (
...
async def ThriftAsyncServerFactory(
    ...
    event_handler must be a subclass of nebula3.fbthrift.server.TServer. If None,
    nebula3.fbthrift.server.TServer.TServerEventHandler is used. Specify a custom handler
